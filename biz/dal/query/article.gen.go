// Code generated by gorm.io/mysql_gen. DO NOT EDIT.
// Code generated by gorm.io/mysql_gen. DO NOT EDIT.
// Code generated by gorm.io/mysql_gen. DO NOT EDIT.
...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.Content = field.NewBytes(tableName, "content")
	_article.AuthorID = field.NewInt64(tableName, "author_id")
	_article.Ctime = field.NewInt64(tableName, "ctime")
	_article.Utime = field.NewInt64(tableName, "utime")
	_article.Published = field.NewBool(tableName, "published")
...
func (a *article) updateTableName(table string) *article {
	...
	a.Utime = field.NewInt64(table, "utime")
	a.Published = field.NewBool(table, "published")
...
func (a *article) fillFieldMap() {
	...
	a.fieldMap["utime"] = a.Utime
	a.fieldMap["published"] = a.Published
}
